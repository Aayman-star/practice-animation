...
const Test2 = () => {
  ...
  return (
    <div
      ref={ref}
      className="bg-yellow-300 w-full h-screen grid place-content-center md:max-w-7xl mx-auto ">
      <motion.div
        variants={{
        ...
        <div className="w-52 h-40 border-2 border-fuchsia-700 rounded-md grid place-content-center">
